...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(f"Base Capital:    ₹{DynamicConfig.DEFAULTS['BASE_CAPITAL']:,.2f} (Dynamic)")
    print(f"Auto Trading:    {'ENABLED 🔴' if DynamicConfig.DEFAULTS['AUTO_TRADING'] else 'DISABLED 🟡'} (Dynamic)")
    print(f"4-Tab API:       ✅")
    print(f"Auth:            X-Upstox-Token Header")
    print(f"Dynamic Config:  ✅ SQLite-backed")
    print(f"Log Streaming:   ✅ Circular Buffer")
    print("=" * 70)
